...
const todos = document.getElementById('nav-item-todos');
const mujeres = document.getElementById('nav-item-mujeres');
const hombres = document.getElementById('nav-item-hombres');
const sinGenero = document.getElementById('nav-item-sinGenero');
const desconocido = document.getElementById('nav-item-desconocido');
...
// Acá escribo como será la paginación
...
// procedo a escribir las acciones del paginado
